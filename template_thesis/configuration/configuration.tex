...
\thesisTitle{Erhöhung der Korrektheit des Zustands in Web-Frontends mit Strikten Übergängen}
\thesisTitleEN{Increasing Correctness in State of Web Frontends with Strict Transitions}

% text field
%-> replace the key words with your own key words
\keywordsDE{State Management, Web, Frontend}
\keywordsEN{State Management, Web, Frontend}

% text field
%-> replace the text with a description of the thesis
\abstractDE{\input{chapters/abstract-de.tex}}
\abstractEN{\input{chapters/abstract-en.tex}}
