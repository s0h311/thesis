...
\thesisTitle{Robusteres State Management in Frontend Webapplikationen mit DFA Übergängen}
\thesisTitleEN{Making State Management in Frontend Web Applications Robuster with DFA Transitions}
